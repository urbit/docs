...
Faceless [`list`](@/docs/reference/library/1c.md#list)

A mold generator. A [`list`](@/docs/reference/library/1c.md#list) without the faces `i` and `t`.
...
Mold of pair of [`list`](@/docs/reference/library/1c.md#list) and type

A mold generator. Produces a tuple of a [`list`](@/docs/reference/library/1c.md#list) of `a` and the mold of `b`.
...
See also: [`++bind`](@/docs/reference/library/2b.md#bind)
