...
`a` by the prime number 16,777,619 and then takes the [block](@/docs/hoon/library/2c.md) of size
...
in [blocks](@/docs/hoon/library/2c.md) of size 3, and `c` as the key, producing an atom.
