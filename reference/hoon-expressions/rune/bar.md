...
See [this discussion of core variance models](/docs/reference/hoon-expressions/advanced)
...
See this [discussion of the core variance model](/docs/reference/hoon-expressions/advanced).
