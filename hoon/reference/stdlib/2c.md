...
`a` is an atom slice specifier (see [`++bite`](@/docs/hoon/reference/stdlib/1c.md#bite)),
which is a block size (see [`++bloq`](@/docs/hoon/reference/stdlib/1c.md#bloq))
...
`b` is a `bloq`. (see [`++bloq`](@/docs/hoon/reference/stdlib/1c.md))
