...
See section [`2f`](@/docs/hoon/library/2f.md) for more information on noun ordering.
...
For more on the tree addressing system, see section [1b](@/docs/hoon/library/1b.md).
