...
First, [install Urbit](/developer/using/install/) on any
...
playing around with Hoon, asking for help from other Urbit devs in [`:talk`](/developer/using/messaging/) if you
