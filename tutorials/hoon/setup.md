...
Once you're finished, you can [boot your very own ship](@/using/install.md). While you can develop in Hoon on your own ship on the live network, we strongly suggest developing on a development ship first.
