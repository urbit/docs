...
But there are more. Check out the aforementioned [Troubleshooting](@/docs/tutorials/hoon-school/hoon-errors.md) page to see other handy debugging runes and how to use them.
