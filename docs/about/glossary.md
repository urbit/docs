...
- A `cell` is an ordered pair of `noun`s.
...
> Why? It's functional: good code has `0` side effects.
...
*See [`twig` concept](/hoon/concepts) and [expressions](/hoon/twig/)*
