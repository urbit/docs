...
Inverts a list of changes `bur`. Skips stay constant and replaces are swapped.
Produces a `bur`.
...
Finds a subsequence of repeated elements within two [`++list`]()s, using several
internal helper arms. Produces a [`++tape`]().
