...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <ul class="list">
            ...
            <br />
            <li><h1><a href="./nock/implementations">Community Nock implementations</a></h1>
            </li>
        </ul>
    </div>
    <div class="col-md-4">
        ...
        <ul class="list">
            <li><code>~master-morzod</code>
                ...
                <p>How to read the Twig docs, a background on the Urbit type
                   system and an overview of Hoon generators.</p>
            </li>
            <br />
            <li><code>~fosnut-dandut</code>
                ...
                <p>Subject-oriented programming, functions and lambdas in Hoon and
                   an attempt to draw parallels with object-oriented programming.</p>
            </li>
            <br />
            <li><code>~palfun-foslup</code>
                <br />
                <h1><a href="https://github.com/Fang-/Urbit-By-Doing">Urbit by Doing</a></h1>
                <p>A dysfunctional programmer's guide to making things in Hoon.
                   A series of tutorials that focus on writing Hoon applications
                   from scratch.</p>
            </li>
            <br />
            <li><code>@knubie</code>
                ...
                <p>A Hoon learning adventure, starting with basic concepts like
                   functions, values, types and variables.</p>
            </li>
        </ul>
    </div>
</div>
