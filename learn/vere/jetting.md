...
holds a pointer into the loom where the actual value is stored. ( see [https://urbit.org/docs/vere/nouns/](../nouns) )
...
Understanding the memory model, allocation, freeing, and ownership ('transfer' vs 'retain' semantics) is important. Some info is available at [https://www.urbit.org/docs/vere/nouns/](../nouns).
